...
class _HomeForYouTabsState extends State<HomeForYouTabs> {
  ...
  Widget build(BuildContext context) {
    ...
    //----END of the MAIN BODY CONTAINERS BEGINS -------

  }


  //--------IMAGE CONTAINER BEGINS ------
  ...
  Widget ImageContainer(){
    ...
    return Container(
      ...
      child: Image.network(
        ...
        'https://lh3.googleusercontent.com/c1Vpus7CzcRjhnZAPvR7z2EhPhn3vFTTwwE-PVY8a8S1XbO5sA67KRjYiJAMyud3oQ=s180',
  ...
  //------PREVIOUSLY INSTALLED APPS CONTAINER BEGINS ----
  ...
  //------END OF THE PREVIOUSLY INSTALLED APPS CONTAINER  ----




  //-----'TEXT ROW inside THE PREVIOUSLY INSTALLED APPS CONTAINER' BEGINS
  ...
  //-----END OF THE 'TEXT ROW inside THE PREVIOUSLY INSTALLED APPS CONTAINER'




  //-----IMAGE of the RECOMMENDED APPS like AMAZON' BEGINS----
  ...
  //-----END of the IMAGE of the RECOMMENDED APPS like AMAZON'----





  //-----RECOMMENDED APPS like AMAZON CONTAINER' BEGINS----
  ...
  //-----END OF THE RECOMMENDED APPS like AMAZON CONTAINER'---




  //------IMAGES of the RECOMMENDED APP Container Begins ----
  ...
  //------END OF THE IMAGES of the RECOMMENDED APP Container  ----
